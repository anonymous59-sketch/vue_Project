...
/*
  ...
  공식사이트    : https://ko.vuejs.org/tutorial/#step-1
*/
...
<template>
  <div class="card">
    <img alt="프로필 사진" class="profile-img" v-bind:src="imgUrl" />
    <h1 v-text="name"></h1>
    <p v-text="info"></p>
    <a target="_blank" class="link-btn" v-bind:href="officialUrl">공식 문서 방문하기</a>
  </div>
</template>
